...
abstract class AbstractPaginator implements PaginatorInterface
{
     ...
     * @var Closure
     */
    protected static $currentPageSizeResolver;
    /**
    ...
    public static function resolveCurrentPage(string $pageName = 'page', int $default = 1): int
    {
        if (isset(static::$currentPageResolver)) {
            return call_user_func(static::$currentPageResolver, $pageName, $default);
        }
     ...
     * Resolve the current page or return the default value.
     */
    public static function resolveCurrentPageSize(string $pageName = 'page_size', int $default = 20): int
    {
        if (isset(static::$currentPageSizeResolver)) {
            return call_user_func(static::$currentPageSizeResolver, $pageName, $default);
        }
     ...
     * Set the current page resolver callback.
     */
    public static function currentPageSizeResolver(Closure $resolver): void
    {
        /** @phpstan-ignore-next-line */
        static::$currentPageSizeResolver = $resolver;
    }
